export default function Hero() {
  return (
    <section className="h-svh bg-black relative overflow-hidden">
      {/* Stars background */}
      ...
      <div className="relative z-1 flex flex-col pt-48 gap-5 px-5 items-center md:px-10 md:pt-72 md:gap-10">
