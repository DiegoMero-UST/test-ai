  ...
  return (
    <section className="px-5 flex flex-col items-center py-20 gap-10">
      ...
      <ul className="flex flex-col items-center gap-10">
        <li className="border-2 border-blue-500 rounded-md p-5 flex flex-col items-start gap-2 ">
          <Image
            src="/chatbot.png"
            alt="Chatbot"
            width={1000}
          ...
          <button className="flex items-center gap-2 mt-2 bg-black text-white px-4 py-2 rounded-md text-2xl">
            Explore
